...
export const LoginPage = ()=>{
    ...
    return(
        <div className="h-screen w-full hero-bg">
            <header className="max-w-64 mx-auto flex items-center justify-between p-4">
                <Link to={'/'}>
                <img src="netflix-logo.png" alt="logo" className='w-53'/>
                </Link>
            </header>
            <div className='flex justify-center items-center mt-7 mx-3'>
