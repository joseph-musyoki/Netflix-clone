...
export const AuthScreen = ()=>{
    ...
    return(
        <div className="hero-bg relative">
            <header className="max-w-52 mx-auto flex items-center justify-between gap-20 p-4 pb-6">
                <img src="netflix-logo.png" alt="logo" className='justify-start w-50 md:w-70'/>
                <Link to={'/login'} className="justify-end text-white bg-red-500 py-1 px-2 rounded font-serif">SIGNIN</Link>
            </header>
            <div className="text-white items-center py-40 max-w-4S0 justify-center flex flex-col mx-auto">
            <h1 className="text-xl md:text-6xl text-white font-bold mb-3">Unlimited movies, Tvs and more</h1>
            <p className="text-lg mb-4">Watch anywhere. Cancel anytime</p>
            <p className="mb-4">ready to Watch? Enter your email to create or restart your membership</p>
            
            <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleSubmit}>
            <input type="email"
                        className='p-2 flex-1 rounded bg-black/80 border border-gray-700'
                        placeholder='you@gmail.com'
                        id='email'
                        value={email}
                        onChange={(e)=>setEmail(e.target.value)} />
            <button className='bg-red-600 text-lg lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>
						Get Started
				<ChevronRight className='size-2 md:size-10' />
			</button>
            </form>
            </div>

            <div className="h-4 w-full bg-[#232329] aria-hidden:true"/>
                ...
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
                    <div className="flex-1">
                        <div className="relative">
                            <img src="stranger-things-lg.png" alt="strangerthings" className="mt-4"/>
                    ...
                    <div className="flex-1 md:text-left text-cente">
